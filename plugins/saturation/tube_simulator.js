...
const TUBE_SIMULATOR_LISTENING_PRESETS = Object.freeze([
    ...
    Object.freeze({
        ...
        params: Object.freeze({
            dr: -58.4629, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: 9.91,
            mx: 100, iv: 2.828, nf: 3, os: 'Power', pt: 'EL84', pb: 330.107,
            kr: 270, st: '20', zp: '6.6', sl: '15', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // power-el34-distributed-20-37w; measured THD 0.1000 %, gain -0.0003 dB.
    Object.freeze({
        id: 'listening-power-el34-distributed-thd0p1', label: 'EL34 Distributed @0.1%',
        params: Object.freeze({
            dr: -56.4629, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: 17.947,
            mx: 100, iv: 2.828, nf: 4, os: 'Power', pt: 'EL34', pb: 443.775,
            kr: 470, st: '43', zp: '6.6', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // power-6l6gc-pentode; measured THD 0.1000 %, gain +0.0002 dB.
    Object.freeze({
        id: 'listening-power-6l6gc-pentode-thd0p1', label: '6L6GC Pentode @0.1%',
        params: Object.freeze({
            dr: -58.4551, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: 17.255,
            mx: 100, iv: 2.828, nf: 3, os: 'Power', pt: '6L6GC', pb: 391.454,
            kr: 483.871, st: '0', zp: '6.6', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // power-kt88-distributed; measured THD 0.1000 %, gain +0.0004 dB.
    Object.freeze({
        id: 'listening-power-kt88-distributed-thd0p1', label: 'KT88 Distributed @0.1%',
        params: Object.freeze({
            dr: -56.4629, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: 21.698,
            mx: 100, iv: 2.828, nf: 4, os: 'Power', pt: 'KT88', pb: 379.29,
            kr: 400, st: '43', zp: '6.0', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    ...
    Object.freeze({
        ...
        params: Object.freeze({
            dr: -15.2227, tp: '12AU7', bi: 0, pv: 250, sz: 10, su: 10, og: 12.027,
            mx: 100, iv: 2.828, nf: 3, os: 'SingleEnded', pt: 'EL84', pb: 329.696,
            kr: 270, st: '0', zp: '8.0', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // se-2a3; measured THD 0.1000 %, gain -0.0004 dB.
    Object.freeze({
        id: 'listening-se-2a3-thd0p1', label: '2A3 SE @0.1%',
        params: Object.freeze({
            dr: -23.2598, tp: '12AU7', bi: 0, pv: 250, sz: 10, su: 10, og: 18.722,
            mx: 100, iv: 2.828, nf: 3, os: 'SingleEnded', pt: 'EL84', pb: 329.696,
            kr: 270, st: '0', zp: '8.0', sl: '8', sd: '2A3', sb: 300,
            sr: 750, sp: '2.5'
        })
    }),
    // power-el84-pentode-10w; measured THD 2.0004 % (target 2.0 %),
    ...
    // power-el84-distributed-10w; measured THD 2.0005 % (target 2.0 %),
    // -12 dBFS AC RMS gain -0.0004 dB.
    Object.freeze({
        id: 'listening-power-el84-distributed-thd2', label: 'EL84 Distributed @2%',
        params: Object.freeze({
            dr: -40.9746, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: -7.091,
            mx: 100, iv: 2.828, nf: 3, os: 'Power', pt: 'EL84', pb: 330.107,
            kr: 270, st: '20', zp: '6.6', sl: '15', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    ...
    Object.freeze({
        ...
        params: Object.freeze({
            dr: -31.6797, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: -6.779,
            mx: 100, iv: 2.828, nf: 4, os: 'Power', pt: 'EL34', pb: 443.775,
            kr: 470, st: '43', zp: '6.6', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // power-6l6gc-pentode; measured THD 1.9998 % (target 2.0 %),
    // -12 dBFS AC RMS gain +0.0002 dB.
    Object.freeze({
        id: 'listening-power-6l6gc-pentode-thd2', label: '6L6GC Pentode @2%',
        params: Object.freeze({
            dr: -35.207, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: -5.145,
            mx: 100, iv: 2.828, nf: 3, os: 'Power', pt: '6L6GC', pb: 391.454,
            kr: 483.871, st: '0', zp: '6.6', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // power-kt88-distributed; measured THD 1.9997 % (target 2.0 %),
    // -12 dBFS AC RMS gain +0.0004 dB.
    Object.freeze({
        id: 'listening-power-kt88-distributed-thd2', label: 'KT88 Distributed @2%',
        params: Object.freeze({
            dr: -31.5391, tp: '12AX7', bi: 0, pv: 250, sz: 10, su: 10, og: -3.147,
            mx: 100, iv: 2.828, nf: 4, os: 'Power', pt: 'KT88', pb: 379.29,
            kr: 400, st: '43', zp: '6.0', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // se-300b; measured THD 2.0000 % (target 2.0 %),
    // -12 dBFS AC RMS gain -0.0002 dB.
    Object.freeze({
        id: 'listening-se-300b-thd2', label: '300B SE @2%',
        params: Object.freeze({
            dr: -2.4824, tp: '12AU7', bi: 0, pv: 250, sz: 10, su: 10, og: -0.439,
            mx: 100, iv: 2.828, nf: 3, os: 'SingleEnded', pt: 'EL84', pb: 329.696,
            kr: 270, st: '0', zp: '8.0', sl: '8', sd: '300B', sb: 400,
            sr: 1000, sp: '3.5'
        })
    }),
    // se-2a3; measured THD 2.0002 % (target 2.0 %),
    // -12 dBFS AC RMS gain -0.0005 dB.
    Object.freeze({
        id: 'listening-se-2a3-thd2', label: '2A3 SE @2%',
        params: Object.freeze({
            dr: -4.2266, tp: '12AU7', bi: 0, pv: 250, sz: 10, su: 10, og: -0.093,
            mx: 100, iv: 2.828, nf: 3, os: 'SingleEnded', pt: 'EL84', pb: 329.696,
            kr: 270, st: '0', zp: '8.0', sl: '8', sd: '2A3', sb: 300,
            sr: 750, sp: '2.5'
        })
...
const TUBE_SIMULATOR_POWER_ONLY_CALIBRATION = Object.freeze({
    'power-el84-pentode-10w': Object.freeze({ dr: -9.7148, iv: 2.828, og: -7.483 }),
    'power-el84-distributed-10w': Object.freeze({ dr: -6.5352, iv: 2.828, og: -7.322 }),
    'power-el34-distributed-20-37w': Object.freeze({ dr: 0, iv: 5.2781, og: -9.51 }),
    'power-6l6gc-pentode': Object.freeze({ dr: 0, iv: 3.3694, og: -7.187 }),
    'power-kt88-distributed': Object.freeze({ dr: 0, iv: 7.4992, og: -10.748 }),
...
const TUBE_SIMULATOR_POWER_ONLY_LOW_DISTORTION_CALIBRATION = Object.freeze({
    'power-el84-pentode-10w': Object.freeze({ dr: -26.5957, iv: 2.828, og: 8.696 }),
    'power-el84-distributed-10w': Object.freeze({ dr: -21.7676, iv: 2.828, og: 7.363 }),
    'power-el34-distributed-20-37w': Object.freeze({ dr: -8.1543, iv: 2.828, og: 3.767 }),
    'power-6l6gc-pentode': Object.freeze({ dr: -19.3047, iv: 2.828, og: 12.251 }),
    'power-kt88-distributed': Object.freeze({ dr: 0, iv: 3.1263, og: -3.485 })
});
const TUBE_SIMULATOR_SE_POWER_CALIBRATION = Object.freeze([
    Object.freeze({
        base: 'se-300b', id: 'power-only-se-300b-thd0p1', label: '300B SE @0.1%',
        params: Object.freeze({ dr: 0, iv: 35.4586, og: 16.582 })
    }),
    Object.freeze({
        base: 'se-300b', id: 'power-only-se-300b-thd1', label: '300B SE @1%',
        params: Object.freeze({ dr: 0, iv: 295.9454, og: -1.794 })
    }),
    Object.freeze({
        base: 'se-2a3', id: 'power-only-se-2a3-thd0p1', label: '2A3 SE @0.1%',
        params: Object.freeze({ dr: 0, iv: 18.1347, og: 21.072 })
    }),
    Object.freeze({
        base: 'se-2a3', id: 'power-only-se-2a3-thd1', label: '2A3 SE @1%',
        params: Object.freeze({ dr: 0, iv: 167.2455, og: 1.816 })
    })
]);
