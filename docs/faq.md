...
| Which music file formats are supported? | Support depends on the browser and OS audio decoder. As a practical baseline, MP3, WAV, and AAC/M4A work in many environments, while FLAC, OGG/Vorbis, and Opus/WebM vary by environment. If a file does not play, try MP3, AAC/M4A, or WAV. |
