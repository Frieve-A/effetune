...
- **Tuning** (-5.0 à +5.0 kHz) - Désaccorde le récepteur par rapport à la station. Les faibles écarts ternissent le son, ajoutent une distorsion de filtrage asymétrique et modifient le volume du sifflement hétérodyne ; les écarts plus importants font sortir la station de l'étroite bande passante FI. En USB et LSB, il décale aussi l'audio restitué, conjointement avec BFO Offset, et la hauteur du sifflement hétérodyne d'une station brouilleuse se décale d'autant.
- **BFO Offset** (-1000 à +1000 Hz) - Règle finement l'oscillateur de battement en USB et LSB ; sans effet en AM. Avec Tuning, il fixe le décalage de fréquence appliqué à tout ce que le récepteur restitue. Ce décalage vaut Tuning × 1000 − BFO Offset hertz : en USB il s'ajoute à chaque composant, en LSB il se retranche de chacun. Zéro correspond au réglage exact sur la fréquence, quelques dizaines de hertz rendent déjà le son nasillard, et des valeurs plus grandes le rendent inintelligible comme le ferait un récepteur mal accordé.
