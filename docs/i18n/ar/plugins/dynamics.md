...
- [Multiband Expander](#multiband-expander) - موسع احترافي بخمس نطاقات لتوسيع النطاق الديناميكي حسب التردد
...
معالج ديناميكي احترافي يقسم الصوت إلى خمسة نطاقات ترددية ويطبق توسيعاً مستقلاً على كل منها. تم تصميم هذه الإضافة لتوسيع النطاق الديناميكي لنطاقات ترددية محددة، مما يجعل الأصوات الهادئة أكثر هدوءاً مع الحفاظ على الأصوات العالية دون تغيير. إنها فعالة بشكل خاص لاستعادة الديناميكيات الطبيعية للتسجيلات المضغوطة بشكل مفرط من الماسترينغ الحديث أو إنشاء تباين ديناميكي أكثر دراماتيكية حسب التردد.

### الميزات الرئيسية
- معالجة بخمسة نطاقات مع ترددات تقاطع قابلة للتعديل
- ضوابط توسيع مستقلة لكل نطاق
- إعدادات افتراضية محسنة تتبع توزيع الطاقة 1/f
- تصور في الوقت الفعلي لزيادة الكسب لكل نطاق
- مرشحات تقاطع Linkwitz-Riley عالية الجودة

### دليل تحسين الاستماع
- **موسيقى البوب/الروك:**
  - تقليل تأثير "جدار الصوت" من الماسترينغ المضغوط بشكل مفرط
...
- **النسبة** (1:0.05 إلى 1:20)
  - يتحكم في كمية التوسيع المطبقة
  - نسب أعلى لتوسيع نطاق ديناميكي أكثر دراماتيكية
- **الهجوم** (0.1 مللي ثانية إلى 100 مللي ثانية)
  - مدى سرعة استجابة التوسيع
  - أوقات أسرع للتحكم الدقيق في الانتقالات
- **الإطلاق** (10 مللي ثانية إلى 1000 مللي ثانية)
...
يأتي Multiband Expander مع إعدادات افتراضية محسنة تتبع توزيع الطاقة 1/f الطبيعي لاستعادة ديناميكيات المواد المضغوطة بشكل مفرط:

- النطاق المنخفض (< 100 هرتز)
  - توسيع لطيف (1.2:1) لديناميكيات باس متحكم فيها
...
### التغذية الراجعة المرئية
- رسوم بيانية تفاعلية لدالة النقل لكل نطاق
- مقاييس زيادة الكسب في الوقت الفعلي تظهر نشاط التوسيع
- تصور نشاط النطاق الترددي
- مؤشرات واضحة لنقاط التقاطع
...
- راقب مقاييس زيادة الكسب لضمان التوسيع المناسب
