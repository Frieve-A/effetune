...
يحرّك Auto Filter مرشحًا رنّانًا تلقائيًا. يكرر وضع **LFO** مسحًا دوريًا، بينما يتبع **Envelope** مستوى الموسيقى لإنتاج صوت Envelope Filter أو Auto Wah.
...
يحرّك Auto Pan مستوى كل زوج ستيريو بين اليسار واليمين. وإذا بقيت قناة غير مزدوجة، تظل في المنتصف.
...
يضيف Chorus نسخًا متحركة ومتأخرة من الموسيقى. تشمل أوضاعه **Stereo Chorus** و**Ensemble** و**Flanger** و**Vibrato**؛ وقد يجعل Delay وDepth الصوت المعالج يبدو متأخرًا قليلًا عن الأصل.
...
- **Depth** ‏(0–20 ms): مقدار تغير التأخير. تُقيّد Depth تلقائيًا بقيمة Delay.
...
ينقل Frequency Shifter كل مكوّن ترددي بعدد ثابت من الهرتز بدلًا من فاصل موسيقي. ينشئ **Ring Mod** نطاقات جانبية معدنية، بينما يوحي **Barber-pole** بنقلة تواصل الصعود أو الهبوط. يضيف التأثير تأخير معالجة قصيرًا يختلف مع sample rate، حتى عند Mix ‏0%.
...
إذا بدا التحويل الكبير خشنًا أو معدنيًا على نحو غير مرغوب، فخفّض Shift أو Mix.

## Phaser

يمزج Phaser الصوت الأصلي مع نسخ مرشحة لإنشاء قمم وفجوات متحركة. يمسح **Classic** ذهابًا وإيابًا، بينما يوحي **Barber-pole** بحركة مستمرة إلى أعلى أو أسفل.
...
مغير درجة صوت أعلى جودة للاستماع الدقيق عندما يستحق تقليل طمس الطور استهلاكًا أكبر للمعالج وتأخيرًا يبلغ نحو 107–116 مللي ثانية. يغير الدرجة من دون تغيير سرعة التشغيل ويحافظ على ترابط المكونات الطيفية أفضل من Pitch Shifter القياسي. إذا لم يتوفر التأثير على جهازك، يمر الصوت من دون تغيير.
...
يقسم Rotary Speaker الصوت بين بوق للترددات العالية وأسطوانة للمنخفضة، ثم يمنحهما سرعتي دوران مختلفتين. تصنع حركة المستوى وتأخير Doppler القصير حركة الدوارين المميزة.
