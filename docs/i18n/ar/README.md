...
2. اختر **إضافة مجلد موسيقى** لفهرسة المجلد الذي يحتوي على ملفات الموسيقى.
...
يبدأ الإصدار 2.1.0 بمكتبة موسيقى جديدة. لا تنتقل حالة المكتبة السابقة، لذا أضف مجلدات الموسيقى وافحصها من جديد. لا يؤدي ذلك إلى تعديل ملفات الصوت داخلها. صُمم الفهرس لقراءة المجموعات الكبيرة من القرص على صفحات. قياسات الأداء واسعة النطاق أدوات تشخيص محلية واختيارية أثناء التطوير؛ وليست شرطًا للـ commit أو الإصدار أو `verify` أو GitHub Actions، ولا تمثل ضمانًا عامًا للأداء.
