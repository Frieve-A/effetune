...
يبدأ الإصدار 3.0.0 بمكتبة موسيقى جديدة. لا تنتقل حالة المكتبة السابقة، لذا أضف مجلدات الموسيقى وافحصها من جديد. لا يؤدي ذلك إلى تعديل ملفات الصوت داخلها. تستهدف البنية أكثر من مليون مقطع؛ ولن يُعلن الدعم الرسمي إلا بعد اجتياز Phase 0 وتأهيل وقت التشغيل كاملًا.
