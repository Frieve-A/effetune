...
3. يمكنك التصفح حسب المقاطع والألبومات والفنانين والأنواع والمجلدات الفرعية والمجلدات والمضافة حديثًا وقوائم التشغيل، والبحث في الفهرس كله باستخدام **البحث في المكتبة**. تجمع **المجلدات الفرعية** المقاطع حسب المسار الذي يحتوي عليها داخل كل مجلد موسيقى مفهرس، بينما تُستخدم **المجلدات** لإدارة مجلدات الموسيقى الجذرية. يظهر هذا التصنيف في المكتبات الحالية من دون إعادة فحص أو ترحيل لتنسيق التخزين.
