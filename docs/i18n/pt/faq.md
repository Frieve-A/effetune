...
| O que a Biblioteca de música faz? | Ela indexa as pastas de música selecionadas para que você possa navegar e pesquisar por faixa, álbum, artista ou gênero, e tocar os resultados no EffeTune. Os metadados da biblioteca e as playlists ficam salvos no aplicativo, não nos arquivos de áudio. |
