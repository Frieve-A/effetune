...
- **Tuning** (-5.0 a +5.0 kHz) - Desloca o receptor em relação à estação. Desvios pequenos abafam o som, acrescentam distorção de filtragem assimétrica e mudam o volume do assobio de heteródino; desvios maiores empurram a estação para fora da estreita banda passante de FI. Em USB e LSB ele também desloca o áudio recuperado, junto com BFO Offset, e a altura do assobio de heteródino de uma estação interferente se desloca na mesma medida.
- **BFO Offset** (-1000 a +1000 Hz) - Ajusta finamente o oscilador de batimento em USB e LSB; não tem efeito em AM. Junto com Tuning, define o deslocamento de frequência aplicado a tudo o que o receptor recupera. Esse deslocamento é Tuning × 1000 − BFO Offset hertz: em USB ele é somado a cada componente e em LSB é subtraído de cada um. Zero é exatamente na frequência, algumas dezenas de hertz já deixam o som anasalado, e valores maiores o tornam ininteligível como faz um receptor dessintonizado.
