...
3. Просматривайте каталог через **Треки**, **Альбомы**, **Исполнители**, **Жанры**, **Подпапки**, **Папки**, **Недавно добавлено** и **Плейлисты**; поле **Поиск в библиотеке** ищет по всему каталогу. Раздел **Подпапки** группирует треки по содержащему их пути внутри каждого импортированного корня, а раздел **Папки** служит для управления этими корнями. Для существующей библиотеки не требуются повторное сканирование или перенос хранилища.
