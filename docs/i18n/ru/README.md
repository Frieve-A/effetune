...
- Музыкальная библиотека для просмотра локальных папок, метаданных и плейлистов
...
В меню **Настройки** откройте **Конфигурация...**, чтобы выбрать язык, **Вид при запуске:** и поведение конвейера эффектов при запуске. Для вида при запуске можно выбрать **Effect Pipeline (по умолчанию)** или **Музыкальная библиотека**.
...
3. Просматривайте каталог через **Треки**, **Альбомы**, **Исполнители**, **Жанры**, **Папки**, **Недавно добавлено** и **Плейлисты**; поле **Поиск в библиотеке** ищет по всему каталогу.
