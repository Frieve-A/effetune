...
2. Выберите **Добавить папку с музыкой** и проиндексируйте папку с музыкальными файлами.
