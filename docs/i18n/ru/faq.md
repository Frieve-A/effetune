...
| Что делает «Музыкальная библиотека»? | Она индексирует выбранные музыкальные папки, чтобы вы могли просматривать и искать треки по названию, альбому, исполнителю или жанру, а затем воспроизводить результаты в EffeTune. Метаданные библиотеки и плейлисты хранятся в приложении, а не в аудиофайлах. |
