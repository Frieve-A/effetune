...
| Какие форматы музыкальных файлов поддерживаются? | Это зависит от возможностей декодирования аудио в браузере и ОС. Как правило, MP3, WAV и AAC/M4A хорошо работают в большинстве сред; поддержка FLAC, OGG/Vorbis и Opus/WebM зависит от конкретной среды. Если файл не воспроизводится, попробуйте MP3, AAC/M4A или WAV. |
