...
- [Multiband Expander](#multiband-expander) - Профессиональный 5-полосный экспандер для расширения динамического диапазона по частотам
...
Процессор динамического диапазона, который расширяет динамический диапазон сигналов ниже порога, делая тихие звуки еще тише, оставляя громкие звуки неизменными. Это создает более драматичную динамику и может помочь восстановить естественную динамику пересжатого материала.
...
- Классическая музыка:
  ...
  - Возвращает естественный поток оркестровых выступлений
- Поп/Рок музыка:
  - Добавляет больше панча и импакта к динамичным секциям
  - Создает более драматичный контраст между куплетами и припевами
  - Восстанавливает естественную динамику сильно сжатых треков
- Джазовая музыка:
  - Улучшает естественную динамику между инструментами
...
- **Threshold** - Устанавливает уровень громкости, где начинается расширение (от -60дБ до 0дБ)
  - Более высокие настройки: Влияет только на более тихие части музыки
  - Более низкие настройки: Создает более общее динамическое расширение
  - Начните с -24дБ для мягкого расширения
- **Ratio** - Контролирует, насколько сильно эффект расширяет динамический диапазон (от 1:0.05 до 1:20)
  - 1:0.5: Восходящее сжатие (усиливает тихие звуки)
  - 1:1: Без эффекта (оригинальный звук)
  - 1:2: Мягкое расширение
  - 1:4: Умеренное расширение
  - 1:8+: Сильное динамическое расширение
- **Attack Time** - Как быстро эффект реагирует на тихие звуки (от 0.1мс до 100мс)
  - Более быстрые времена: Более мгновенный динамический контроль
  - Более медленные времена: Более естественный звук
  - Попробуйте 10мс как начальную точку
- **Release Time** - Как быстро динамика возвращается к норме (от 10мс до 1000мс)
  - Более быстрые времена: Более динамичный звук
  - Более медленные времена: Более плавные, естественные переходы
  - Начните с 100мс для общего прослушивания
- **Knee** - Насколько плавно эффект переходит (от 0дБ до 12дБ)
  - Более низкие значения: Более точный контроль
  - Более высокие значения: Более мягкий, естественный звук
  - 3дБ - хорошая начальная точка
- **Gain** - Регулирует общую громкость после обработки (от -12дБ до +12дБ)
  - Используйте для соответствия громкости с оригинальным звуком
  - Увеличьте, если музыка кажется слишком тихой
  - Уменьшите, если слишком громкая
...
Профессиональный процессор динамики, который разделяет аудио на пять частотных полос и применяет независимое расширение к каждой. Этот плагин предназначен для расширения динамического диапазона определенных частотных диапазонов, делая тихие звуки еще тише, сохраняя громкие звуки неизменными. Он особенно эффективен для восстановления естественной динамики перекомпрессированных записей современного мастеринга или создания более драматического динамического контраста по частотам.

### Ключевые особенности
- 5-полосная обработка с настраиваемыми частотами раздела
- Независимые регуляторы расширения для каждой полосы
- Оптимизированные настройки по умолчанию, следующие распределению энергии 1/f
- Визуализация увеличения усиления по полосам в реальном времени
- Высококачественные кроссоверные фильтры Linkwitz-Riley

### Руководство по улучшению прослушивания
- **Поп/Рок музыка:**
  - Уменьшение эффекта "стены звука" от перекомпрессированного мастеринга
...
- **Threshold** (от -60дБ до 0дБ)
  ...
  - Сигналы ниже этого уровня будут расширены (станут тише)
- **Ratio** (от 1:0.05 до 1:20)
  - Контролирует степень применяемого расширения
  - Более высокие соотношения для более драматического расширения диапазона
- **Attack** (от 0.1мс до 100мс)
...
Multiband Expander поставляется с оптимизированными настройками по умолчанию, следующими естественному распределению энергии 1/f для восстановления динамики перекомпрессированного материала:
...
- Низко-средняя полоса (100-500 Гц)
  ...
  - Порог следует спаду энергии -6дБ
...
### Visual Feedback
- Интерактивные графики передаточной функции для каждой полосы
- Измерители увеличения усиления в реальном времени, показывающие активность расширения
- Визуализация активности частотных полос
- Четкие индикаторы точек раздела
...
- Следите за измерителями увеличения усиления для обеспечения правильного расширения
