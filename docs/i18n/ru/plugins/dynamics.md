...
description: "Плагины динамической обработки: Compressor, Limiter, Gate, Multiband Compressor и Transient Shaper."
lang: ru
---
...
- **Margin** (от -1.000дБ до 0.000дБ)
  - Добавляет к Threshold точный безопасный сдвиг
  - Фактический потолок равен Threshold + Margin
...
- Информация об уменьшении усиления передается внутри плагина для индикаторов хоста или статуса
