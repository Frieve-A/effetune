...
- [Multiband Expander](#multiband-expander) - 주파수 대역별 다이나믹 레인지 확장을 위한 전문가급 5밴드 익스팬더
...
오디오를 5개의 주파수 대역으로 분할하고 각각에 독립적인 익스팬션 처리를 적용하는 전문가급 다이나믹 프로세서입니다. 이 플러그인은 특정 주파수 범위의 다이나믹 레인지를 확장하여 조용한 소리는 더 조용하게 만들고 큰 소리는 그대로 유지합니다. 현대 마스터링에서 과도하게 압축된 녹음의 자연스러운 다이나믹스를 복원하거나 더 극적인 주파수별 다이나믹 콘트라스트를 만드는 데 특히 효과적입니다.

### 주요 기능
- 조절 가능한 크로스오버 주파수를 갖춘 5밴드 처리
- 각 밴드별 독립적인 익스팬션 제어
- 1/f 에너지 분포를 따르는 최적화된 기본 설정
- 밴드별 게인 부스트의 실시간 시각화
- 고품질 Linkwitz-Riley 크로스오버 필터

### 청취 향상 가이드
- **팝/록 음악:**
  - 과도하게 압축된 마스터링의 "벽처럼 느껴지는" 사운드 효과 감소
...
- **Threshold** (-60dB ~ 0dB)
  - 익스팬션이 시작되는 레벨 설정
  - 이 레벨 이하의 신호가 확장됨 (더 조용해짐)
- **Ratio** (1:0.05 ~ 1:20)
  - 적용되는 익스팬션 양 제어
  - 더 극적인 다이나믹 레인지 확장을 위한 높은 비율
- **Attack** (0.1ms ~ 100ms)
  - 익스팬션 응답 속도
...
### 다이나믹 레인지 복원
Multiband Expander는 과도하게 압축된 소재의 다이나믹스를 복원하기 위해 자연스러운 1/f 에너지 분포를 따르는 최적화된 기본 설정을 제공합니다:
