...
- **Gramophone** - 오래된 어쿠스틱 축음기 색채를 지닌 크게 벌어진 혼입니다.
- **Vintage Theater** - 저역까지 내려가는 대형 극장용 혼의 응답입니다.
- **Megaphone** - 직접적이고 강조된 중역을 지닌 짧은 원뿔형 혼입니다.
...
효과 헤더의 **효과 프리셋**을 클릭하면 공명 패턴 전체를 불러올 수 있습니다.

- **Wooden Body** - 낮은 주파수에서 오래 지속되는 공명 모드로 목재 캐비닛의 특성을 더합니다.
- **Metal Can** - 높은 주파수에서 오래 울리는 공명 모드로 금속성 특성을 더합니다.
- **Plastic Enclosure** - 높은 주파수에서 짧게 울리는 공명 모드로 가벼운 외함의 특성을 더합니다.
