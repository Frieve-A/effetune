...
エフェクトヘッダーの**エフェクトプリセット**をクリックすると、ホーンの代表的な音色をまとめて設定できます。

- **Gramophone** - 古い蓄音機らしい色づけを持つ、大きく開いたホーンです。
- **Vintage Theater** - 低い帯域まで届く、大型劇場ホーンの響きです。
- **Megaphone** - 直接的で張りのある中域を持つ、短い円すい形ホーンです。
...
エフェクトヘッダーの**エフェクトプリセット**をクリックすると、より滑らかなPlusモデルで同じ3種類のホーン音色を試せます。
...
エフェクト見出しの**エフェクトプリセット**で、共鳴パターン全体を読み込めます。

- **Wooden Body** - 木製キャビネットを思わせる、低く長く残るモード。
- **Metal Can** - 金属的なキャラクターを持つ、高く長く鳴るモード。
- **Plastic Enclosure** - 軽い筐体を思わせる、短く高いモード。
