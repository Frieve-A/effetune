...
対応するグラフのスペクトラムアイコンを押すと、そのエフェクトを通過した後の音のスペクトラム線がグラフに薄く重なって表示されます。聴きながら、調整によって低域・中域・高域がどう変わるかを確認できます。スペクトラムのレベルは、グラフ右側のdBFS目盛で読みます。この目盛はグラフのゲイン目盛とは別で、0 dBFSはデジタル音声のフルスケール基準、より低い値ほど小さいレベルを表します。スペクトラムの解析と描画は、表示中だけ行われます。
