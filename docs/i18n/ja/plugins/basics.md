...
デスクトップアプリで出力チャンネル数を4、6、または8に設定し、エフェクトのバスルーティングで **All** を選択してください。チャンネル1-2がステレオ入力になり、後続のステレオ出力ペアへ低域から順に各帯域が送られます。
...
- 出力チャンネル数が4、6、8のいずれでもない場合は、チャンネル構成の警告が表示されます。
