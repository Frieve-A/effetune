...
1. ウェブアプリでは左上の **オーディオをリセット** ボタンをクリック、またはデスクトップアプリでは表示メニューからリロードを選択する
