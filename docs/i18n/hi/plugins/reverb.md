...
प्लेट रीवर्ब की पूरी सेटिंग एक साथ लागू करने के लिए इफ़ेक्ट के शीर्षक में **इफ़ेक्ट प्रीसेट** पर क्लिक करें।

- **Studio Plate** - रोज़मर्रा में सुनने के लिए छोटा और चमकीला प्लेट रीवर्ब।
- **Vocal Plate** - लंबे प्री-डिले से मूल ध्वनि का शुरुआती अटैक रीवर्ब से अलग रहता है।
- **Dark Vintage Plate** - ऊँची फ़्रीक्वेंसी का अधिक डैम्पिंग करने वाला, गहरा प्लेट रीवर्ब।
- **Long Wash** - मॉड्यूलेशन के साथ लंबी और फैलती हुई गूँज।
...
रूटिंग नोट: FDN Reverb सभी routed input channels का औसत एक साझा feedback tank में भेजता है। tank हर sample में एक बार आगे बढ़ता है और उसके wet taps routed output channels में बाँटे जाते हैं।
...
- **Tight Room** - छोटे और नियंत्रित कमरे की प्रतिध्वनि।
- **Warm Hall** - अकूस्टिक और ऑर्केस्ट्रल संगीत के लिए लंबा, हल्का मद्धम हॉल।
- **Bright Plate** - प्लेट जैसा चरित्र रखने वाला अधिक चमकीला और जीवंत छोटा रिवर्ब।
- **Vast Cavern** - उपलब्ध स्थानों में सबसे बड़ा और सबसे लंबा।
...
इम्पोर्ट की गई IR files **Impulse Response Library** में रखी जाती हैं, जहाँ आप मूल filename से उन्हें खोज, load या delete कर सकते हैं। कई IR को एक साथ हटाने के लिए उनके checkbox चुनें, या अभी दिखाई दे रहे सभी items चुनने के लिए **Ctrl+A** (macOS पर **Command+A**) दबाएँ, फिर **चुनी हुई हटाएँ** चुनें। WAV audio वाली `.irs` extension की files का नाम बदले बिना उन्हें इम्पोर्ट किया जा सकता है। Web app में ये files browser में save होती हैं और site data मिटाने या browser द्वारा storage खाली करने पर खो सकती हैं। Desktop app इन्हें अपने application data में रखता है। हर जरूरी IR की अलग copy रखें।
...
- **Small Room** - 5 ms pre-delay वाला छोटा और निकट कमरे का माहौल।
- **Jazz Club** - 15 ms pre-delay वाला अंतरंग acoustic सामग्री के लिए मध्यम कमरा।
- **Concert Hall** - 25 ms pre-delay और अधिक समृद्ध bass decay वाला कॉन्सर्ट हॉल।
- **Cathedral** - 40 ms pre-delay और सबसे समृद्ध bass decay वाला लंबा, गहरा प्रतिध्वनि स्थान।

### पैरामीटर
- **Pre-Delay** (0 से 50 ms) - रीवर्ब की परावर्तित ध्वनि को रूम मॉडल में पहुँचने से पहले विलंबित करता है। मान बढ़ाने पर मूल ध्वनि की शुरुआत अधिक देर तक अलग और स्पष्ट सुनाई देती है, लेकिन रूम मॉडल का अपना विलंब बना रहता है।
