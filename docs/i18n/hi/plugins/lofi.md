...
- **Tape Artifacts** संगीत को ही बदलता है। हल्की compression, जुड़ती हुई गर्माहट, नरम पड़ती ऊंची आवृत्तियां और pitch का हल्का बहाव — सब एक ही रिकॉर्ड और प्लेबैक शृंखला से आते हैं, इसलिए ये सब Speed, Tape, Bias और Input Peak पर एक साथ प्रतिक्रिया देते हैं।
...
- **हल्की level compression:** Input Peak जितना नीचे घोषित करेंगे, टेप उतना ही पहले — साफ़ सुनाई देने वाली distortion से पहले ही — peaks को गोल कर देता है, इसलिए तेज़ हिस्से स्पष्ट रूप से clip होने के बजाय अधिक सघन और स्थिर हो जाते हैं। डिफ़ॉल्ट -6.0 dBFS और संदर्भ 0.0 dB Bias पर टेप ठहरे हुए material के peaks से केवल कुछ सौवां हिस्सा decibel घटाता है, और तीखे transients तथा शोर से अधिकतम लगभग 0.8 dB। जितना नीचा peak घोषित करेंगे यह मात्रा उतनी ही सहजता से बढ़ती है — -15.0 dBFS पर material के peak वाले tone पर यह 0.4 dB होती है। डिफ़ॉल्ट पर इससे बड़ा जो भी level परिवर्तन दिखे वह compression से नहीं बल्कि टोन बदलने से आता है, और वह material के अनुसार दोनों दिशाओं में जाता है: भारी निचली आवृत्तियों वाला संगीत लगभग 1 dB तेज़ और ऊंची आवृत्तियों से भरा material लगभग 1 dB धीमा निकल सकता है।
- **गर्माहट:** saturation असममित है, इसलिए यह सम और विषम दोनों harmonics बनाता है और गर्माहट Input Peak घटने के साथ अचानक आने के बजाय धीरे-धीरे बढ़ती है।
...
- **जीवंत पृष्ठभूमि:** सामान्य settings पर hiss और संगीत के साथ चलने वाला modulation noise ध्वनि का हिस्सा होते हैं। पूरी तरह शांत पृष्ठभूमि चाहिए तो Hiss को -110.0 dBFS तक नीचे कर दें।

### पैरामीटर

- **Speed** (7.5 / 15 / 30 ips) - टेप की गति चुनता है। अधिक गति ऊंची आवृत्तियों को बढ़ाती है और निचली आवृत्तियों के head bump को ऊंची आवृत्ति की ओर ले जाकर छोटा करती है: 7.5 ips पर 41 Hz पर +1.4 dB, 15 ips पर 80 Hz पर +0.8 dB, 30 ips पर 159 Hz पर +0.4 dB। wow और flutter तेज़ भी होते हैं और उथले भी: Wow/Flutter 15 ips पर weighted विचलन बताता है और गति उसे 7.5 ips पर 1.5 गुना तथा 30 ips पर 0.75 गुना कर देती है, इसलिए संदर्भ मशीन 15 ips के लिए जो 0.04% प्रकाशित करती है, वह बाकी दोनों गतियों पर वही 0.06% और 0.03% देता है जो वह उनके लिए प्रकाशित करती है। शोर गति के साथ एक ही दिशा में नहीं चलता: hiss floor 15 ips पर सबसे ऊंचा और 30 ips पर सबसे नीचा है, जबकि संगीत के साथ चलने वाला modulation noise 7.5 ips पर सबसे तेज़ है। 15 ips सामान्य स्टूडियो setting है, 7.5 ips सबसे गहरा है, और 30 ips मूल ध्वनि के सबसे करीब है। Wow/Flutter और Hiss दोनों संदर्भ 15 ips के लिए दिए गए हैं, और चुने हुए Speed तथा Tape पर दोनों के प्रभावी मान effect की अंतिम पंक्ति में दिखते हैं।
- **Tape** (Standard / Master) - टेप का प्रकार चुनता है। Master की coating मोटी है और saturation से पहले लगभग 3 dB अधिक headroom है, इसलिए यह अधिक देर तक साफ़ रहती है और इसका ऊपरी सिरा थोड़ा नरम होता है। Input Peak ऊंचा हो तो दोनों का स्तर लगभग बराबर रहता है (डिफ़ॉल्ट पर 0.02 dB का अंतर), पर Input Peak जितना नीचे रखेंगे उतना ही Master तेज़ बनी रहती है: -24.0 dBFS पर 1.2 dB और -36.0 dBFS पर 3.8 dB का अंतर — ठीक इसीलिए कि वह देर से saturate होती है; इसलिए तुलना करते समय Output से आवाज़ बराबर करें।
...
- **Input Peak** (-36.0 से 0.0 dBFS) - टेप को बताता है कि आपका material कितना तेज़ है। आप घोषित करते हैं कि आपके संगीत का peak कहां है, और मॉडल उस peak को टेप के कार्य बिंदु पर रख देता है, जो -18.0 dBFS के peak के बराबर है। यह नियंत्रण स्वयं कोई gain नहीं लगाता: जब तक टेप संतृप्त नहीं होता, वही संकेत हर स्थिति पर उसी स्तर पर निकलता है। यह स्तर ठीक इकाई नहीं है — यह उससे 0.1 dB के भीतर रहता है, 30 ips पर थोड़ा ऊपर और 7.5 ips पर थोड़ा नीचे — पर Input Peak के साथ यह हिलता नहीं। डिफ़ॉल्ट -6.0 dBFS सामान्य आधुनिक master के लिए उपयुक्त है; यदि आपको अपने material का peak पता न हो तो इसे वैसा ही रहने दें और कान से समायोजित करें। यहां दिए गए आंकड़े और नीचे दी गई settings लगभग -6.0 dBFS peak वाले संगीत को मानकर रखी गई हैं; यदि आपके material का peak कहीं और है तो Input Peak को उतने ही अंतर से खिसका दें, बाकी मान वैसे ही काम करेंगे। असली peak से नीचा मान घोषित करने पर टेप उतने ही अंतर से अधिक ज़ोर से चलता है, और टेप जैसी compression और गर्माहट इसी तरह मिलती है: material के peak पर 1 kHz का tone डिफ़ॉल्ट पर 0.12% distort करता है, -18.0 dBFS पर 2% और -24.0 dBFS पर 6.8%, जबकि सामान्य संगीत पर उसी setting पर peaks 2.7 dB और -36.0 dBFS पर 12 dB नीचे आ जाते हैं। यह गिरावट टेप द्वारा peaks को चपटा करने से आती है, नियंत्रण द्वारा आवाज़ घटाने से नहीं; टेप जितने ज़ोर से चलेगा परिणाम उतना ही धीमा होगा, और आवाज़ वापस लाने के लिए Output है।
...
1. **स्टूडियो मास्टर टेप (डिफ़ॉल्ट)**
   ...
   - रोज़मर्रा की टेप ध्वनि, और plugin का अपना डिफ़ॉल्ट भी: 16 kHz पर ऊपरी सिरा 3.5 dB नरम, 80 Hz के आसपास 0.8 dB का उभार, peaks पर 0.12% distortion, -83.5 dBFS का hiss floor और 0.160% wow व flutter — लंबे स्वरों पर सुनाई देता है, transients पर नहीं।
...
2. **तेज़ गति पर साफ़ transfer**
   ...
   - मूल ध्वनि के बहुत करीब: peaks पर 0.015% distortion, 16 kHz पर 2.2 dB की कमी, -93.0 dBFS की पृष्ठभूमि — यानी -89.5 dBFS का Base मान 30 ips पर Master टेप के साथ जो बन जाता है, Output 0.0 dB पर — और 0.053% wow व flutter। peak को असल से 6 dB ऊंचा घोषित करने पर टेप पर पड़ने वाला ज़ोर 6 dB घट जाता है, और इसी से यह इतना साफ़ रहता है। बाकी settings की तुलना करते समय संदर्भ बिंदु के रूप में उपयोगी।

3. **गर्म और सघन**
   - Speed: 15 ips, Tape: Standard, Bias: 0.0 dB, Input Peak: -24.0 dBFS
   - Wow/Flutter: 0.200%, Hiss: -83.5 dBFS, Output: +0.5 dB, Mix: 100%
   - Input Peak असली peak से 18 dB नीचे घोषित है, इसलिए टेप सामान्य से 18 dB अधिक ज़ोर से चलता है — उस बिंदु से लगभग 4 dB आगे जहां तीसरी harmonic distortion 3% तक पहुंचती है। सामान्य material पर Peaks 2.7 dB और crest factor 2.4 dB घटते हैं (peaks की गिरावट material के अनुसार 1.6 से 4.4 dB तक रहती है), इसलिए mix अधिक सघन और गर्म हो जाता है, peaks पर distortion 6.8% रहती है। compression आवाज़ घटा देती है, इसलिए Output नीचे नहीं बल्कि थोड़ा ऊपर जाता है; अंत में कान से समायोजित करें।
...
4. **7.5 ips पर घरेलू deck**
   ...
   - अधिक गहरा (16 kHz पर 9.8 dB की कमी, 50 Hz पर 1.8 dB का उभार — दोनों इस preset के +0.5 dB Output के बाद के), अधिक शोर भरा (पृष्ठभूमि -81.5 dBFS, यानी टेप की अपनी -82.0 dBFS floor में वही Output जुड़कर) और कम स्थिर (0.450% wow व flutter), peaks पर distortion 1.4%। bias थोड़ा ऊंचा रखा गया है, जैसा सामान्य टेप चलाने वाले घरेलू deck में प्रायः होता है — स्टूडियो मशीन नहीं, बल्कि एक साधारण मशीन।
...
5. **घिसा हुआ transport**
   ...
   - 0.720% wow व flutter, peaks पर 15% distortion, टेप की अपनी -79.0 dBFS floor में इस preset के +1.5 dB Output जुड़कर बनी -77.5 dBFS की पृष्ठभूमि, और under-bias मशीन जैसा खुरदरा, आगे निकला हुआ ऊपरी सिरा। सामान्य material पर Peaks 5.5 dB और material के अनुसार 9 dB तक गिरते हैं, इसलिए आवाज़ वापस लाने के लिए Output बढ़ाना पड़ता है। जानबूझकर बिगाड़ा गया lo-fi प्रभाव।
