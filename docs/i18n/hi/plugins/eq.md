...
- **Low-frequency Phase Extension** - Phase Low के नीचे frequency कम होने के साथ लंबी होती frequency-dependent analysis windows का उपयोग करके measured excess-phase correction को Phase Low से Correction Low की ओर बढ़ाती है। Phase Low और उससे ऊपर fixed analysis window का उपयोग होता है। यह setting default रूप से बंद रहती है। यह केवल Correction में उपलब्ध है; Minimum और Linear में चुना गया value बना रहता है लेकिन control disabled होता है। यदि measured impulse response माँगी गई low-frequency window से छोटी हो, तो Room EQ उपलब्ध छोटी measurement window का उपयोग करके warning दिखाता है। Correction केवल तभी घटाई या छोड़ी जाती है जब तैयार FIR अपनी time limit के पास पहुँच जाए या filter-design calculation budget पार हो जाए; Room EQ filter का बाकी हिस्सा सक्रिय रहता है। यह extension केवल तभी काम करती है जब Phase Correction 0% से अधिक हो; 0% पर यह Reverb Correction उपयोग में होने पर भी निष्क्रिय रहती है।
...
- **Reverb Correction** - मापी गई room reverberation की correction को 0% से 100% तक 1% के steps में सेट करता है और केवल Correction mode में काम करता है; Minimum और Linear में values बनी रहती हैं लेकिन controls disabled रहते हैं। Default 0% पर reverb correction पूरी तरह बंद रहती है और Room EQ ठीक वैसे ही व्यवहार करता है जैसे यह control न हो। 0% से ऊपर Room EQ, Reverb Window भर response का analysis करता है और Reverb Max Freq तक direct sound के बाद जारी रहने वाली reverberation को counteract करता है: यह reverberation की excess phase को Phase Correction से independent रूप से correct करता है और उसी band में Reverb Smoothing को follow करने वाली बारीक magnitude correction जोड़ता है, जो comb जैसी ripple और धीरे-धीरे decay होने वाले room modes घटाती है। यह बारीक magnitude correction, Max Boost के भीतर रहती है और बाकी automatic magnitude correction की तरह Level Correction से scale होती है। Phase Low के नीचे, जहाँ direct-sound phase correction नहीं पहुँचती, यह विशुद्ध रूप से अतिरिक्त correction की तरह काम करती है। कई measurement points होने पर जहाँ points सहमत नहीं होते वहाँ correction अपने आप घटाई जाती है, जिससे default परिणाम पूरे listening area में स्वाभाविक रहता है; एक ही measurement point होने पर यह सुरक्षा उपलब्ध नहीं होती, इसलिए correction सख्ती से मापी गई position पर लागू होती है। उपयोग योग्य reverb window या frequency band बहुत छोटी होने पर, या संश्लेषित reverb correction के तैयार FIR की time limit के भीतर सुरक्षित रूप से न समा पाने पर, Room EQ reverb correction घटाता या छोड़ देता है और warning दिखाता है; filter का बाकी हिस्सा सक्रिय रहता है।
- **Reverb Window** - सेट करता है कि reverb correction, direct-sound onset के बाद की मापी गई response का 20 से 1000 ms तक कितना हिस्सा analyze और counteract करे। लंबी windows बाद की reverberation तक पहुँचती हैं। प्रभावी reverb window, FIR tap count, Direct Window और onset के बाद मापी गई impulse response की लंबाई से अपने आप सीमित होती है, इसलिए यह दिखाए गए value से छोटी हो सकती है; default 32768 taps और 96 kHz पर ऊपरी सीमा लगभग 170 ms है। जिस उच्चतम frequency तक reverb की बारीक संरचना follow की जा सकती है वह window की गहराई के व्युत्क्रमानुपात में घटती है — लगभग f < 1/(0.0139 × प्रभावी window), प्रभावी 170.7 ms पर लगभग 420 Hz और 300 ms पर लगभग 240 Hz। यदि प्रभावी window, Direct Window से अधिक न हो — चाहे taps budget से, छोटी मापी गई impulse response से या Direct Window के बराबर या उससे कम सेट किए गए Reverb Window से — तो reverb correction पूरी तरह छोड़ दी जाती है और warning दिखती है; filter का बाकी हिस्सा सक्रिय रहता है।
...
- **Reverb Smoothing** - 0.02 से 1.00 octave की Gaussian smoothing, जिसे reverb correction अपने phase analysis और बारीक magnitude correction दोनों में उपयोग करती है। Default 0.05 oct मुख्य Smoothing से कहीं बारीक है, ताकि correction उस संकरी ripple को follow कर सके जो reverberation response में बनाती है। बड़ी value reverb correction को व्यापक और अधिक conservative बनाती है। कई measurement points होने पर यह वह frequency scale भी तय करती है जिस पर उनकी सहमति परखी जाती है।
- **Reference Point** - Correction में direct-sound और reverb दोनों analyses के लिए excess phase का source चुनता है। **सहमति (सभी बिंदु)** default और fallback है: यह points को समय में align करता है, उनकी excess phase जोड़ता है, गहरे response nulls के पास अविश्वसनीय phase को कम weight देता है और जहाँ points सहमत नहीं होते वहाँ correction घटाता है। किसी नामित point को चुनने पर केवल उसी की excess phase उपयोग होती है। Magnitude correction हमेशा सभी points का उपयोग करता है। चुना हुआ point हटाने पर setting सहमति पर लौट जाती है।
...
- **Min Group Delay** magnitude response के minimum-phase हिस्से से बनने वाला delay दिखाता है। **Excess Group Delay** उस हिस्से को हटाने के बाद बचा delay अलग से दिखाता है, जिससे reflections और अन्य non-minimum-phase timing को समझना आसान होता है। दोनों views में horizontal axis logarithmic frequency और vertical axis milliseconds दिखाता है। हर line अपने 1kHz value के सापेक्ष होती है, इसलिए दोनों वहाँ 0 ms पर होती हैं और positive value का अर्थ 1kHz के मुकाबले delay है। धूसर line correction से पहले की और हरी line वास्तविक FIR लगाने के बाद की calculated स्थिति है। Slope पास-पास वाले display points के बीच लिया जाता है और केवल Smoothing वाला वही एक pass लगता है जो measured frequency response पर लगता है; कम Smoothing अधिक detail दिखाता है। Vertical range अपने आप बदलती है। Impulse response न होने पर unavailable message दिखाई देता है।
