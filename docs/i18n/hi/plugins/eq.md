...
- **Low-frequency Phase Extension** default रूप से बंद रहती है, जिससे Correction का मौजूदा व्यवहार और पुराने presets की ध्वनि बनी रहती है। Phase Low के नीचे excess phase correct करनी हो तभी इसे चालू करें। Frequency कम होने पर analysis windows लगातार लंबी होती जाती हैं और room response का बाद का हिस्सा भी शामिल हो सकता है, इसलिए सहमति से शुरुआत करना सबसे सुरक्षित है। एक से अधिक listening positions पर तुलना करें और bass timing कम consistent लगे तो extension बंद कर दें।
