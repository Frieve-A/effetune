...
नियंत्रण **Preset** के नीचे पाँच टैब में बाँटे गए हैं।
...
Power और Transformer टैब केवल चुने गए Output Circuit में काम आने वाले नियंत्रण दिखाते हैं। किसी preset से circuit या tone parameter बदलने पर **Custom** दिखाई देता है।

### Preset चुनना

Tube Simulator **EL84 Pentode @2%** से शुरू होता है; circuit या tone parameter बदलने पर preset का नाम **Custom** हो जाता है, जबकि **Output Safety Trim** और **Auto Gain Reduction** preset matching में शामिल नहीं हैं, इसलिए इन्हें बदलने से preset का नाम नहीं बदलता।
