...
ग्राफ़ के बाहर दिए **Graph** radio buttons से view चुनें। **Frequency** स्तर, **Phase** चरण, **Min Group Delay** magnitude response के minimum-phase हिस्से से बनने वाला delay, **Excess Group Delay** उस हिस्से को हटाने के बाद बचा delay और **Impulse** time response दिखाता है। ग्राफ़ हमेशा **Before** और **After** दिखाता है। दोनों मान पढ़ने के लिए पॉइंटर चलाएँ; **Before** पर पॉइंटर रखने से **After** अस्थायी रूप से छिप जाता है। Frequency, Phase और दोनों Group Delay views में **Smoothing (oct)** लागू होता है। पढ़ने में आसानी के लिए Excess Group Delay graph की display range ±100 ms तक सीमित है, लेकिन pointer इस range के बाहर भी मूल मान दिखाता है। हर frequency curve को अलग से 0 dB पर रखा जाता है; हर impulse अपने सबसे बड़े peak से सामान्यीकृत होकर -2 ms से चुनी हुई **Impulse Range (ms)** तक दिखता है।
