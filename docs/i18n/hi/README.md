...
2.1.0 एक नई संगीत लाइब्रेरी से शुरू होता है। पिछली लाइब्रेरी की स्थिति नहीं अपनाई जाती, इसलिए संगीत फ़ोल्डर दोबारा जोड़कर स्कैन करें। इससे उन फ़ोल्डर की ऑडियो फ़ाइलें नहीं बदलतीं। कैटलॉग को बड़ी लाइब्रेरी डिस्क से पृष्ठों में पढ़ने के लिए बनाया गया है। बड़े पैमाने की प्रदर्शन मापें केवल वैकल्पिक, स्थानीय विकास निदान हैं; वे commit, release, `verify` या GitHub Actions की शर्त नहीं हैं और सामान्य प्रदर्शन की गारंटी भी नहीं देतीं।
