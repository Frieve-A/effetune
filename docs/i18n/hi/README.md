...
- स्थानीय फ़ोल्डर, मेटाडेटा और प्लेलिस्ट ब्राउज़ करने के लिए संगीत लाइब्रेरी
...
**सेटिंग्स** मेनू में **कॉन्फ़िगरेशन...** खोलें। यहां आप भाषा, **स्टार्टअप पर दिखाया जाने वाला दृश्य:**, और स्टार्टअप पर Effect Pipeline के व्यवहार को चुन सकते हैं। स्टार्टअप दृश्य के लिए **Effect Pipeline (डिफ़ॉल्ट)** या **संगीत लाइब्रेरी** चुना जा सकता है।
...
3. **ट्रैक**, **एल्बम**, **कलाकार**, **शैलियाँ**, **फ़ोल्डर**, **हाल में जोड़े गए**, और **प्लेलिस्ट** से ब्राउज़ करें, और **लाइब्रेरी खोजें** से पूरे कैटलॉग में खोजें।
