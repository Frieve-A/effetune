...
वर्चुअल ऑडियो डिवाइस के बिना Chrome या Edge के एक टैब को प्रोसेस करें। [ब्राउज़र एक्सटेंशन गाइड](browser-extension.md) देखें।
...
- इफ़ेक्ट पैरामीटर के लिए दशमलव बिंदु, चिह्न बदलने और अनुमत सीमा वाला मोबाइल नंबर कीपैड
...
1. फ़ाइल ड्रॉप या फ़ाइल स्पेसिफिकेशन क्षेत्र:
   ...
   - इफेक्ट Pipeline के sample rate पर प्रोसेस होते हैं; आउटपुट sample-rate conversion उसके बाद होता है
...
3. डाउनलोड या सेव विकल्प:
   - **Settings > Config > ऑफ़लाइन फ़ाइल आउटपुट** में WAV या FLAC के साथ sample rate और quality चुनें। FLAC के लिए 16-bit या 24-bit lossless encoding चुनें। शुरुआती सेटिंग 96 kHz, 24-bit PCM WAV है
   - हर फ़ॉर्मेट की channel limit अलग है। चुनी गई सीमा से अधिक चैनल होने पर EffeTune अपने-आप downmix नहीं करता, बल्कि समाधान दिखाकर रुक जाता है
