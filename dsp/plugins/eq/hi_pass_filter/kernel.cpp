...
#include "HiPassFilterPluginParams.h"
...
Coefficients designSecondOrder(double sample_rate, double frequency, double q) noexcept {
  ...
  return {k2q / a0, -2.0 * k2q / a0, k2q / a0, (-2.0 * k2q + 2.0 * omega2q) / a0,
...
class HiPassFilterKernel final : public PluginKernel {
  EFFETUNE_PARAMS(generated::HiPassFilterPluginParams)
...
EFFETUNE_REGISTER_KERNEL(HiPassFilterPlugin, effetune::plugins::eq::HiPassFilterKernel)
