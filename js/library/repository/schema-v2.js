...
export const MUSIC_LIBRARY_V2_DESKTOP_DIRECTORY = 'music-library-v2';
export const MUSIC_LIBRARY_V2_DESKTOP_DATABASE_PATH = 'music-library-v2/catalog.sqlite';
export const MUSIC_LIBRARY_V2_ARTWORK_DIRECTORY = 'music-library-v2/artwork';
export const MUSIC_LIBRARY_V2_CACHE_DIRECTORY = 'music-library-v2/cache';
export const MUSIC_LIBRARY_V2_WEB_OPFS_DIRECTORY = 'effetune-music-library-sqlite-v2';
export const MUSIC_LIBRARY_V2_WEB_DATABASE = 'catalog-v2.sqlite3';
...
export const MUSIC_LIBRARY_V2_PRAGMAS_SQL = `
PRAGMA foreign_keys = ON;
PRAGMA journal_mode = WAL;
`;

export const MUSIC_LIBRARY_V2_WEB_PRAGMAS_SQL = `
PRAGMA foreign_keys = ON;
...
BEGIN
  ...
  INSERT OR IGNORE INTO query_context_track_before_images(
    context_token, track_uid, existed, track_key, folder_id, title, artist,
  ...
  SELECT context_token, OLD.track_uid, 1, OLD.track_key, OLD.folder_id, OLD.title,
...
export function getMusicLibraryV2InitializationSql({ includePragmas = true, journalMode = 'wal' } = {}) {
