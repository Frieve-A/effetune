...
export class IncrementalSha256 {
  ...
  update(value) {
    if (this.finished) throw new TypeError('SHA-256 digest is already finished');
  ...
  digestHex() {
    ...
    view.setUint32(tailLength - 8, Math.floor(bitLength / 0x1_0000_0000));
    view.setUint32(tailLength - 4, bitLength >>> 0);
    for (let offset = 0; offset < tailLength; offset += 64) this.#process(tail, offset);
