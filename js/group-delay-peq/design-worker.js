import { designGroupDelayPeqFilter } from './design-core.js';
...
globalThis.onmessage = event => {
    ...
    try {
        const result = designGroupDelayPeqFilter(request.config);
        ...
        globalThis.postMessage({
            type: 'error',
            requestId: request.requestId,
            message: error instanceof Error ? error.message : 'Group Delay PEQ filter design failed.'
        });
    }
};
