...
test('client maps its catalog, scan, operation, and playlist API to the versioned Worker protocol', async () => {
  ...
  const mappings = [
    ...
    ['recordRecentlyPlayed', [{ trackUid: 'track-1' }], 'recordRecentlyPlayed'],
    ['setTrackFavorite', [{ trackUid: 'track-1', favorite: true }], 'setTrackFavorite'],
    ['getFavoriteTrackUids', [{ limit: 25, cursor: { position: 1024, itemKey: 7 } }], 'getFavoriteTrackUids'],
    ['getSystemPlaylists', [], 'getSystemPlaylists'],
