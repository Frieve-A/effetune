...
const ports = [
  {
    ...
    jsEngineHash: '7277c6acc838ebe2bff059666dbba411444ea620811170680f658e318f72598d',
    caseIds: [
      'default-impulse',
  ...
  },
  {
    ...
    jsEngineHash: 'e974ec908312ca7b4d6a0c6d1a3d47e4061a3f4abadb45a1f32bb44209e9f687',
    caseIds: [
      'default-impulse',
      'minimum-controls-44100',
      'maximum-controls-192000',
  ...
  },
  {
    ...
    jsEngineHash: '292930b6cb0975ddd491094b8c22550a98a59e1775b2c22dcae3715c1a02fdae',
    caseIds: [
      'default-impulse',
      'minimum-controls-44100',
      'maximum-controls-192000',
...
test('reverb kernels and native tests pin realtime lifecycle and capacity contracts', async () => {
  ...
  assert.match(readme, /\| Storage \| Float32 samples \| Bytes \|[\s\S]*\| Complete instance \| 2,196,480 \| 8,785,920 \|/);
});
